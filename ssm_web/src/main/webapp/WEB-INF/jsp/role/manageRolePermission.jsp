...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<form
				action="${pageContext.request.contextPath}/role/saveRolePermission?id=${role.id}"
				method="post">
				<!-- 正文区域 -->
					...
					<table id="dataList"
							...
							<tbody>
								<c:forEach items="${permissions}" var="permission">
									<tr>
										<td><input name="ids" type="checkbox" ${fn:contains(pstr,permission.permissionName)==true?"checked":""} value="${permission.id}"></td>
										<td>${permission.id}</td>
