...
<body class="hold-transition skin-blue sidebar-mini">
		...
		<div class="content-wrapper">
			...
			<div class="box box-primary">
				...
				<div class="box-footer">
					...
					<div class="box-tools pull-right">
						<ul class="pagination">
							<li><a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=1" aria-label="Previous">首页</a></li>
							<li><a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${pageInfo.prePage}">上一页</a></li>
							<c:forEach items="${pageInfo.navigatepageNums}" var="i">
							<li><a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${i}">${i}</a></li>
							</c:forEach>
							<li><a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${pageInfo.nextPage}">下一页</a></li>
							<li><a href="${pageContext.request.contextPath}/order/findAllOrder?pageNum=${pageInfo.pages}" aria-label="Next">尾页</a></li>
						</ul>
					</div>
	...
	<script>
		...
		function topage() {
			...
			window.location.href="${pageContext.request.contextPath}/order/findAllOrder?pageSize="+selectSize;
        }
	</script>
</body>
